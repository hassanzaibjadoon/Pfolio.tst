(function ($) {
  ...
  */
    ...
    if ($.exists('#contact-form #submit')) {
      ...
      $('#contact-form #submit').on('click', function (e) {
        ...
        if (name !== '' && email !== '' && msg !== '') {
          ...
          const serviceID = "service_grph5ox"; // Replace with your EmailJS Service ID
          ...
          emailjs.send(serviceID, templateID, params)
            ...
            .catch(error => {
              $('#st-alert').fadeIn().html('<div class="alert alert-danger"><strong>Error!</strong> Failed to send the email. Please try again later.</div>');
  ...
  // Initialize EmailJS
  emailjs.init("service_grph5ox"); // Replace 'YOUR_USER_ID' with your actual EmailJS User ID
